...
Still missing: everything else under `product-search/` (domain, application/ports, presentation), `.env.example`, `.github/workflows/ci.yml`, and the Postman collection. Everything below this point describes the target design — don't assume a piece is implemented without checking. Update this section as pieces land.
